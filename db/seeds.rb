...
flat_1 = Flat.create(name: 'Little flat in Paris', address: 'Paris, France', description: 'Some description', price: 120, user: lucy)
...
flat_2 = Flat.create(name: 'Giant flat in London', address: 'London, UK', description: 'Some description', price: 250, user: lucy)
...
flat_3 = Flat.create(name: 'Cozy flat in Budapest', address: 'Budapest, Hungary', description: 'Some description', price: 50, user: john)
